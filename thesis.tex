...
%% 2026 Revision : Han Xirui, adapted to 2026 NUDT thesis format requirements
...
\professionalfield{人工智能} % 专业学位领域（仅专业学位填写）
...
% 公开评阅信息（提交最终版存档时填写，评阅/盲评版删除此段）
\begin{publicreviewinfo}
\hline
1 & 张~~三 & 教~~授 & 博导 & XXX大学 & 100 & A & 有深入了解 & \\
\hline
2 & 李~~四 & 研究员 & 博导 & 国防科技大学 & 85 & B & 比较熟悉 & \\
\hline
3 & 王~~五 & 教~~授 & 硕导 & 国防科技大学 & 70 & C & 有深入了解 & \\
\hline
4 & 赵~~六 & 教~~授 & 博导 & XXX大学 & 90 & B & 有深入了解 & \\
\hline
5 & 孙~~六 & 教~~授 & 博导 & XXX大学 & 100 & A & 有深入了解 & \\
\hline
\end{publicreviewinfo}

% 答辩委员会（提交最终版存档时填写，评阅/答辩版删除此段）
\begin{defensecommittee}
\end{defensecommittee}

% 复核专家组（进行了学术复核者填写，否则删除此段）
\begin{reviewexpertgroup}
\end{reviewexpertgroup}
